...
- **Mã NB được ít nhất hai nguồn dữ liệu xác nhận không còn nằm chờ duyệt:** hệ thống tự ghi nhận vật tư vào danh mục cho mọi mã HQ đã khai trên tờ khai, nhưng mã NB bóc tách từ ngoặc đơn trong tên hàng — nằm trên đúng dòng tờ khai đó — thì không, mà xếp vào hàng chờ người duyệt. Trên dữ liệu Growatt có 2.593 mã NB vừa được khai trên tờ khai, vừa có trong BOM, vừa có trong bảng BQD do chính khách hàng lập, nhưng vẫn nằm ở trang "Mã chờ duyệt" như thể cần người xác nhận; trong khi suốt lịch sử hệ thống chưa từng có mã nào bị từ chối, và nút duyệt hàng loạt chưa từng được người dùng bấm lần nào kể từ khi ra mắt. 2.593 mã này nay đã vào danh mục theo đúng phân loại quan sát được (2.570 nguyên vật liệu + 23 thành phẩm), ghi nhật ký dưới tên tác nhân hệ thống chứ không ghi là người dùng duyệt. Điều kiện áp dụng là mã phải được **ít nhất hai trong ba nguồn** xác nhận: bóc tách từ ngoặc là suy đoán bằng biểu thức chính quy, còn BOM và BQD là chuỗi lấy nguyên văn từ tệp do khách hàng lập — nên một quy tắc bóc tách sai chỉ sinh ra mã có mỗi nguồn tờ khai, và mã như vậy vẫn nằm chờ duyệt. Cùng lẽ đó, 73 mã chỉ có trong BOM (mã nội bộ nhà cung cấp) và 34 mã chỉ có trong BQD cũng được giữ lại chờ duyệt. Hàng đợi Growatt: 2.912 → 318 mã (111 mã hiện + 207 mã máy móc vốn đã ẩn); danh mục 850 → 3.443 vật tư; số mã BOM chưa có vật tư trong danh mục: 2.109 → 74. Khách hàng Johnson không bị ảnh hưởng (không dùng mã NB trong ngoặc nên không có mã nào chờ duyệt). Refs #53.
