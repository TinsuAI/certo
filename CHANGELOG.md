...
### Sửa
- **Màn "Xác nhận thay đổi BCCT" nay chỉ rõ vì sao nút "Apply confirmed changes" bị khoá:** khi file BCCT có mã đơn vị tính khác họ chưa xác nhận, nút bị khoá cho tới khi tích ô xác nhận drift trong khung cảnh báo vàng — nhưng trước đây không có chỉ dẫn nào, nên tích ô "ghi đè N dòng đã đổi" ngay cạnh nút mà nút vẫn xám thì người dùng tưởng hỏng. Tình huống Johnson VN: 51 dòng đổi ngày hoá đơn kèm 604 mã khác họ, tích ô 51 dòng nhưng nút không bật. Nay phía trên nút hiện dòng nhắc: nút đang khoá vì còn drift khác họ, kèm liên kết cuộn tới và chọn đúng ô xác nhận; nói rõ ô "ghi đè N dòng" không mở nút (chỉ quyết định có ghi đè các dòng đổi hay không) và không cần gán hệ số cho từng mã để nhập được. Dòng nhắc chỉ hiện khi có drift chặn và tự ẩn khi đã tích xác nhận. Refs #56.
- **Nút xác nhận drift không còn kẹt khoá sau khi tải lại trang:** khung cảnh báo drift khoá nút xác nhận lúc tải trang rồi chỉ mở lại qua sự kiện tích ô. Trình duyệt khôi phục trạng thái đã tích của ô sau một lần tải lại nhưng không phát lại sự kiện thay đổi, nên nút kẹt xám dù ô đã tích — không có cách bật lại ngoài việc bỏ tích rồi tích lại. Nay lúc tải trang nút bám theo đúng trạng thái hiện tại của ô xác nhận. Ảnh hưởng cả màn nhập BCCT lẫn BOM (dùng chung khung cảnh báo). Refs #58.
