...
'chay vong lap dien gia tri
    ...
    hang = Excel.WorksheetFunction.Match(.Cells(i, 17), ThisWorkbook.Sheets("Save").Range("W2:W" & lastRow2), 0)
       For j = 2 To 4
            ...
            .Cells(i, j) = Excel.WorksheetFunction.Index(lookupRange, hang, cot) ' dung ham index& match de lay data ten hàng,hs,dvt
       Next
        ...
        ' tinh tri gia trong nuoc & ngoai nuoc
            ...
            If .Range("S" & i) = "" Or .Range("S" & i) = "E15" Then
...
'Function myVlookup(lookupValue, lookupRange, columnIndex As Long) lay nhieu gia tri dua vao 1 o excel
...
'tao file excel moi
Dim wb, oldWb As Workbook
Dim Sh As Worksheet
Dim sFileName As String ' dua con tro vao file name trong o J8
Dim xPath As String ' tao duong dan
    Set oldWb = ActiveWorkbook ' select wb cu
    xPath = Application.ActiveWorkbook.Path ' tao duong dan luu wb dang lua chon
        For Each Sh In ActiveWindow.SelectedSheets ' bien sh chay tu cac sheet dang chon
            ...
            Sh.Copy wb.Sheets(1) ' copy sheet cua wb cu sang wb moi
            Range("A1:AA500").Copy
            ...
            oldWb.Activate ' chuyen select sang wb goc de khac phuc loi
            .Range("A16:U85") = "" ' xoa data wb goc di cho bang LVC tiep theo
            'Call XoaLVC ' goi ham sub
        Next Sh ' tao sheet moi
    Workbooks(sFileName).Activate ' quay tro ve wb moi khoi tao
       ...
       Next
        ...
        ' tinh tri gia trong nuoc & ngoai nuoc
            ...
            If .Range("J" & i) = "Vi" & ChrW(7879) & "t Nam" Then 'có xuat xu
                ...
                .Range("H" & i) = .Range("F" & i) * .Range("G" & i) 'tinh tri giá có xuat xu
            Else: .Range("G" & i) = Excel.WorksheetFunction.Index(lookupRange, hang, cot) ' tinh don gia ko xuat xu
            .Range("I" & i) = .Range("F" & i) * .Range("G" & i) 'tinh tri gia ko xuat xu
            End If
