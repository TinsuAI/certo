Option Explicit
Sub index_Match2()
Dim lookupRange As Range, vlookupRange As Range, lookupRangeXK1 As Range, lookupRangeXK2 As Range, r As Range
Dim i As Long, j As Long, k As Long, l As Long, stt As Long, hang As Long, cot As Long
Dim lastRow As Long, lastRow2 As Long, lastRow3 As Long, lastRow4 As Long, lastRow5 As Long
Dim result1 As String, result2 As String, result3 As String, result4 As String, result5 As String
Dim findStartNumL As Integer, findStartNumN As Integer
Dim wsSave As Worksheet, wsDM As Worksheet, wsXK As Worksheet
...
lastRow2 = wsSave.Cells(.Rows.Count, "E").End(xlUp).row
lastRow3 = wsDM.Cells(.Rows.Count, "F").End(xlUp).row
Set lookupRange = wsSave.Range("A2:Q" & lastRow2)
...
Set lookupRangeXK2 = ThisWorkbook.Sheets("XK").Range("Q11:BB" & lastRow4)
    ...
    ' bây loi neu ô Q9 = rông
        If .Range("Q9") = "" Then
            MsgBox "Ô Q9 dang rong!", vbExclamation
            Exit Sub
        End If
        
      ' bây loi neu ô ty giá
      Dim tyGia As Long
        tyGia = Application.VLookup(.Range("Q9"), lookupRangeXK1, 10, 0) ' ty gia
        If IsError(tyGia) Then
           MsgBox "Lôi: Không t́m thây ty giá tkx: " & .Range("Q9"), vbCritical
            Exit Sub
        Else
        .Range("P6") = tyGia
        End If
        
       ' bây loi neu ô incoterm
      Dim incoterm As String
        incoterm = Application.VLookup(.Range("Q9"), lookupRangeXK1, 17, 0) ' incoterm
        If IsError(incoterm) Then
           MsgBox "Lôi: Không t́m thây incoterm tkx: " & .Range("Q9"), vbCritical
            Exit Sub
        Else
        .Range("O8") = incoterm
        End If
        
       ' bây loi neu ô tông tri giá
      Dim tongTriGia As String
        tongTriGia = Application.SumIf(wsXK.Range("B11:B" & lastRow4), _
        .Range("Q9"), wsXK.Range("AE11:AE" & lastRow4))  ' tong tri gia
        If IsError(tongTriGia) Then
           MsgBox "Lôi: Không t́m thây tông tri giá tkx: " & .Range("Q9"), vbCritical
            Exit Sub
        Else
        .Range("P10") = tongTriGia
        End If
    ...
    ThisWorkbook.Sheets("LVC").Activate ' chuyen select sang wb goc de khac phuc loi
        ...
        .Range("K7") = Application.VLookup(.Range("V" & l), lookupRangeXK2, 7, 0) ' ten sp
        .Range("K8") = Left(Application.VLookup(.Range("V" & l), lookupRangeXK2, 6, 0), 6) ' HS code sp
        .Range("P8") = Application.VLookup(.Range("V" & l), lookupRangeXK2, 9, 0) ' don gia
        .Range("L9") = Application.VLookup(.Range("V" & l), lookupRangeXK2, 12, 0) ' dvt
        .Range("K9") = Application.VLookup(.Range("V" & l), lookupRangeXK2, 11, 0) ' so luong
        .Range("P9") = Application.VLookup(.Range("V" & l), lookupRangeXK2, 11, 0) ' so luong
        .Range("K10") = .Range("P8") * .Range("P9") ' tri gia incoterm
...
' tinh toan gia tri footer
    ...
    ' tong IV chi phi xuat xuong
         .Range("I100") = .Range("H88") + .Range("I88") + .Range("I93") + .Range("I99")
        ...
        If .Range("O8") = "EXW" Or .Range("O8") = "FCR" Then ' neu tk khai giá EXW
            ...
            .Range("I102") = .Range("K10") ' tong VI gia xuat xuong
            .Range("I101") = .Range("I102") - .Range("I100") ' Loi nhuan
        ...
        Dim freight As Long
            freight = (.Range("K10") / .Range("P10")) * .Range("P104") ' cuoc biên
            .Range("I104") = .Range("K10") - freight ' tong VIII giá FOB
            .Range("I103") = (.Range("K10") / .Range("P10")) * .Range("P103") ' tong VII phi van chuyen
            .Range("I102") = .Range("I104") - .Range("I103") ' tong VI gia xuat xuong
            .Range("I101") = .Range("I102") - .Range("I100") ' Loi nhuan
            .Range("K11") = .Range("I104") ' tri gia FOB
            '.Range("B11") = ChrW(272) & ChrW(417) & ChrW(110) & " giá FOB: " & .Range("K11") / .Range("K9") & " USD" ' don gia FOB
...
Set lookupRangeXK2 = ThisWorkbook.Sheets("XK").Range("Q11:BB" & lastRow4)
    ...
    ThisWorkbook.Sheets("EUR1").Activate ' chuyen select sang wb goc de khac phuc loi
        .Range("P7") = .Range("W" & l) ' mă SP vao ô P7
        .Range("K7") = Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 7, 0) ' ten sp
        .Range("K8") = Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 6, 0) ' HS code sp
        .Range("P8") = Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 9, 0) ' don gia
        .Range("L9") = Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 12, 0) ' dvt
        .Range("K9") = Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 11, 0) ' so luong
        .Range("P9") = Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 11, 0) ' so luong
        
        .Range("B10") = ChrW(272) & ChrW(417) & "n giá " & .Range("O8") & ": " _
        & Round(Application.WorksheetFunction.VLookup(.Range("V" & l), lookupRangeXK2, 9, 0), 2) & " USD" ' don gia EXW
...
' an hàng rong  khong chua du lieu
    For i = 16 To 85
        If .Range("A" & i) = "" Then
            Worksheets("EUR1").Rows(i).Hidden = True
        End If
    Next
 ' an cot du thua di
        .Range("O1:Y1").EntireColumn.Hidden = True
...
' tinh toan gia tri footer
    ...
    ' tong IV chi phi xuat xuong
         .Range("I100") = .Range("H88") + .Range("I88") + .Range("I93") + .Range("I99")
         Dim wsXK As Worksheet
         Set wsXK = ThisWorkbook.Sheets("XK")

        If .Range("O8") = "EXW" Or .Range("O8") = "FCR" Then ' neu tk khai giá EXW
            .Range("K11") = .Range("K10") + (.Range("K10") / .Range("P10")) * .Range("P103") ' tri gia FOB
            .Range("B11") = ChrW(272) & ChrW(417) & ChrW(110) & " giá FOB: " & Round(.Range("K11") / .Range("K9"), 2) & " USD" ' don gia FOB
            .Range("I102") = .Range("K10") ' tong VI gia xuat xuong
            .Range("I101") = .Range("I102") - .Range("I100") ' Loi nhuan
            .Range("I103") = (.Range("K10") / .Range("P10")) * .Range("P103") ' tong VII phi van chuyen
            .Range("I104") = .Range("K11") ' tong VIII giá FOB
            .Range("C112") = Application.SumIf(wsXK.Range("B11:B" & lastRow4), .Range("Q9"), wsXK.Range("AE11:AE" & lastRow4)) 'tông tri giá exw
        ...
        ElseIf .Range("O8") = "FOB" Then ' neu tk khai giá FOB
            ...
            .Range("I102") = .Range("I104") - .Range("I103")  ' tong VI gia xuat xuong
            .Range("I101") = .Range("I102") - .Range("I100") ' Loi nhuan
            .Range("C112") = Application.SumIf(wsXK.Range("B11:B" & lastRow4), .Range("Q9"), wsXK.Range("AE11:AE" & lastRow4)) - .Range("P103") 'tông tri giá exw
        ...
        Dim freight As Long
            ...
            .Range("K11") = .Range("I104") ' tri gia FOB
            .Range("B11") = ChrW(272) & ChrW(417) & ChrW(110) & " giá FOB: " & .Range("K11") / .Range("K9") & " USD" ' don gia FOB
            .Range("C112") = Application.SumIf(wsXK.Range("B11:B" & lastRow4), .Range("Q9"), wsXK.Range("AE11:AE" & lastRow4)) - .Range("P103") - -.Range("P104") 'tông tri giá exw
            
        End If
        
        ' Tính EUR1
     
            .Range("C111") = .Range("P103") ' tong VII phi van chuyen = Tông các chi phí tu công ty den cang xuât (1):
            .Range("C113") = (.Range("C111") + .Range("C112")) / .Range("C112") ' he sô K
            .Range("C114") = .Range("P8") / .Range("C113")
            .Range("C115") = (.Range("H88") + .Range("I88")) / .Range("I102") * 100 & " %"
