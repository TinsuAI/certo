                ...
                material["allocation_lines"].append(
                    {
                        ...
                        "product_sequence": form.get(allocation_prefix + "product_sequence", ""),
                        "product_code": form.get(allocation_prefix + "product_code", ""),
                        "material_sequence": form.get(allocation_prefix + "material_sequence", ""),
                        "opening_qty": form.get(allocation_prefix + "opening_qty", ""),
