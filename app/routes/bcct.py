...
def _list_bcct(client_id: str, year: int | None, direction: str | None,
    ...
    sql = f"""
        select b.transaction_key, b.line_no, b.declaration_no, b.declaration_type,
               ...
               b.goods_name, b.hs_code, b.quantity, b.unit,
               b.total_value, b.total_value_nt,
               b.currency_nt, b.origin,
        ...
        cur.execute(
            ...
            insert into hub.bcct_rows
              (client_id, transaction_key, line_no, declaration_no,
               ...
               internal_mgmt_no, package_marks,
               upload_id, payload)
            ...
            on conflict (client_id, year, transaction_key, line_no) do update set
              ...
              unit_price_nt = excluded.unit_price_nt,
              total_value = excluded.total_value,
              total_value_nt = excluded.total_value_nt,
              currency_nt = excluded.currency_nt,
            ...
            (client_id, r["transaction_key"], r.get("line_no", "0"),
             ...
             r.get("unit_price"), r.get("unit_price_nt"),
             r.get("total_value"), r.get("total_value_nt"),
             r.get("currency_nt") or r.get("currency"),
             r.get("total_tax"), r.get("unloading_location"),
             r.get("origin"), r.get("invoice_ref"),
             ...
             r.get("contract_no"), r.get("contract_date"),
             r.get("internal_mgmt_no"), r.get("package_marks"),
