...
from app.routes import admin, agent, api, auth_api, bcct, bom, bqd, catalog, catalog_candidates, client_config_ui, clients, master_data, notifications as notif_routes, proposals, uploads
