...
def migrate_config(config: dict, client: dict) -> dict:
    ...
    # The 2026-08-17 ingest-time currency switch is gone: every lot now carries both
    # money lanes and the choice is per sheet. Drop a stale key so it can never
    # resurrect a mode nothing reads.
    merged["co_stock"].pop("value_basis", None)
